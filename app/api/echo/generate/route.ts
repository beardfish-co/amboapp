...
- Do not pile up triple-parallel constructions. Phrases like "wounds acknowledged, grace received, mercy extended" or "questions we cannot answer, worries that will not leave, responsibilities that weigh heavily" are AI tells. Two parallel phrases is fine. One is often better. Vary your sentence rhythm. This applies even when the source homily itself uses triple-parallel structures — do not mirror the preacher's rhetorical patterns, break or compress them.
